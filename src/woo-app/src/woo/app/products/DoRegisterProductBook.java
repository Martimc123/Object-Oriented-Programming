...
public class DoRegisterProductBook extends Command<Storefront> {
  ...
  public final void execute() throws DialogException,UnknownSupplierKeyException {
    ...
    try {
      ...
      {
        _receiver.create_Book(_id.value().toLowerCase(),_sup_id.value().toLowerCase(),_price.value(),_critic_value.value(),0,_title.value(),_author.value(),
        _isbn.value());
        _receiver.create_BookSpec(_id.value().toLowerCase(),_sup_id.value().toLowerCase(),_price.value(),_critic_value.value(),0,_title.value(),_author.value(),
